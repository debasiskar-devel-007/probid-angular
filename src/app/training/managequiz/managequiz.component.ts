...
export class ManagequizComponent implements OnInit {
  ...
  constructor(es: FormBuilder, public apiService: ApiService,public router:Router,public http:HttpClient,public modalservices:BsModalService,public cookie:CookieService, public route:ActivatedRoute)
  {
    this.serverurl=apiService.nodesslurl;
    this.es=es;
  ...
  dosubmit() {
    ...
    if (this.dataForm.valid) {
      let link = this.apiService.nodesslurl + 'addorupdatedata?token='+this.cookie.get('jwtToken');
      let objarr=['lessonid'];
  ...
  delete(template:TemplateRef<any>)
  {
    ...
    const link = this.apiService.nodesslurl+'deletesingledata?token='+this.cookie.get('jwtToken');
    this.modalref.hide();
